...
- [README.md](/home/saturnzzz/skyed/prototype_v2/YOLO26n/profile_640_fp16_archery_target/README.md)
...
```bash
cd /home/saturnzzz/skyed
bash /home/saturnzzz/skyed/prototype_v2/YOLO26n/profile_640_fp16_archery_target/streaming/run_mk15_csi_rtsp.sh
```
...
```bash
cd /home/saturnzzz/skyed
bash /home/saturnzzz/skyed/prototype_v2/YOLO26n/profile_640_fp16_archery_target/streaming/run_mk15_yolo_rtsp.sh
```
...
```bash
cd /home/saturnzzz/skyed
BITRATE=10000000 bash /home/saturnzzz/skyed/prototype_v2/YOLO26n/profile_640_fp16_archery_target/streaming/run_mk15_yolo_rtsp.sh
```
...
This explicit block matches the normal wrapper defaults for the real stream application.
If you intentionally want the separate headless field-safe variant, override `SHOW=0`
before calling the same wrapper.
...
```bash
cd /home/saturnzzz/skyed
SHOW=0 RTSP_ENABLE=1 bash /home/saturnzzz/skyed/prototype_v2/YOLO26n/profile_640_fp16_archery_target/streaming/run_mk15_yolo_gimbal_rtsp.sh
```
